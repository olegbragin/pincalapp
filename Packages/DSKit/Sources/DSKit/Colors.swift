...
public extension Color {
    enum dsKit {
        public static let colorBackground = Color("colorBackground", bundle: .module)
        public static let colorBackgroundMain = Color("colorBackgroundMain", bundle: .module)
        public static let colorBackgroundDisabled = Color("colorBackgroundDisabled", bundle: .module)
        ...
        public static let colorForegroundOnEventCard = Color("colorForegroundOnEventCard", bundle: .module)
